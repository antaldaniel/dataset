...
small_country_dataset <- dataset_df(
  ...
  gdp = labelled_unit(c(3897, 7365), label = "Gross Domestic Product", unit = "million dollars"), 
...
```{r percapita}
small_country_dataset$gdp_capita <- labelled_unit(
...
```{r summarynewlabelled}
summary(small_country_dataset$gdp_capita)
```
In this case, 
